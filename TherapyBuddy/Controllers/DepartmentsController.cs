    ...
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentID,DepartmentName")] Department department)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                TempData["Message"] = "Successfully created Roles -" + department.DepartmentName;
        ...
        public ActionResult Edit([Bind(Include = "DepartmentID,DepartmentName")] Department department)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                TempData["Message"] = "Successfully editted Roles -" + department.DepartmentName;
                return RedirectToAction("Index");
            }
            return View(department);
        }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.SaveChanges();
            TempData["Message"] = "Successfully deleted Roles -" + department.DepartmentName;
            return RedirectToAction("Index");
        }
